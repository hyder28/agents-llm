...
def python_repl_tool(
    code: Annotated[str, "The python code to execute to generate your chart."]) -> str:
...
search_agent = create_react_agent(llm, tools = [brave_search])
...
# for s in research_graph.stream({"messages": [("user", "when did Gojira play in Istanbul?")]}, {"recursion_limit": 100}):
#     print(s)
#     print("---")
...
chart_generating_agnet = create_react_agent(llm, tools = [read_document, python_repl_tool])
...
#     {"messages": [("user", "Write an outline for song lyrics about LangChain and then write the it to disk")],
#     "recursion_limit": 100}):
#     print(s)
#     print("---")
llm = ChatOpenAI(model = "gpt-4o")
...
user_msg = \
    "Research Shiba Inu dog breed and write a brief report about the pet."
